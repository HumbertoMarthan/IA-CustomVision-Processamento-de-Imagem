...
/*Faz o Upload da Foto para a pasta de escolha... No caso a pasta Test dentro do projeto*/
public void upload() {
		try {
			String caminho = 
...
public void testar() {
			...
			try {
			  ...
			  /*String name = "7d190085-1232-44d6-80e3-3bb85945315f";
				String source = name;
				byte[] bytes = source.getBytes("UTF-8");
				UUID projeto = UUID.nameUUIDFromBytes(bytes);
				Project project = trainer.getProject(projeto);*/
				...
				//azul tag
				Tag azulTag = trainer.createTag()
						.withProjectId(project.id())
						.withName("Azul")
						.execute();

				//castanho tag
				Tag castanhoTag = trainer.createTag()
						.withProjectId(project.id())
						.withName("Castanho")
						.execute();
